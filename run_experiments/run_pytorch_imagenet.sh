...
## resnet50, no optimizations. only 3 workers
python ../src/train_pytorch.py --name pytorch_resnet18_GPU --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --num_workers 3 --use_dali -bs 64 128 256 --width 256 --height 256 --crop 224 --num_classes 1000
## resnet50, no optimizations. 8 workers
...
## resnet50, no optimizations. only 3 workers
python ../src/train_pytorch.py --name pytorch_resnet18_CPU --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --num_workers 3 --use_dali --dali_cpu -bs 64 128 256 --width 256 --height 256 --crop 224 --num_classes 1000
## resnet50, no optimizations. 8 workers
