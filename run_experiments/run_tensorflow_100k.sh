...
# resnet50, no tf.data optimizations. only 3 workers
python ../src/train_tensorflow.py --name tensorflow_resnet50_GPU_def_opt --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --num_workers 3 --use_dali --limit_memory_growth -bs 128 256 512
# resnet50, no tf.data optimizations. 8 workers
python ../src/train_tensorflow.py --name tensorflow_resnet50_GPU_def_opt --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --num_workers 8 --use_dali --limit_memory_growth -bs 128 256 512
...
# resnet50, tf.data autotune optimizations 
python ../src/train_tensorflow.py --name tensorflow_resnet50_GPU --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --autotune --use_dali -bs 128 256 512
...
# resnet50, no tf.data optimizations. only 3 workers
python ../src/train_tensorflow.py --name tensorflow_resnet50_CPU --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --num_workers 3 --use_dali --dali_cpu -bs 128 256 512
# resnet50, no tf.data optimizations. 8 workers
...
# resnet50, tf.data autotune optimizations
python ../src/train_tensorflow.py --name tensorflow_resnet50_CPU --log_path $LOG_PATH --train_path $TRAIN_DIR --test_path $VAL_DIR --gpu_profiler --autotune --use_dali --dali_cpu -bs 128 256 512